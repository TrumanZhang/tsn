...
#ifndef NESTING_COMMON_SCHEDULE_SCHEDULEMANAGERTMP_H_
#define NESTING_COMMON_SCHEDULE_SCHEDULEMANAGERTMP_H_
...
template<typename T>
class ScheduleManagerTmp : public IClockListener {
protected:
...
public:
    ScheduleManagerTmp(IClock* clock, T adminStates) {
        this.adminStates = adminStates;
        this.operStates = adminStates;
    }

    virtual ~ScheduleManagerTmp() {}
