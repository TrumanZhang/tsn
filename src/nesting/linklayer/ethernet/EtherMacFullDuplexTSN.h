...
#ifndef __INET_EtherMacFullDuplexTSN_H
#define __INET_EtherMacFullDuplexTSN_H
 ...
 */
class INET_API EtherMacFullDuplexTSN : public EtherMacBase
{
  public:
    EtherMacFullDuplexTSN();
...
#endif // ifndef __INET_EtherMacFullDuplexTSN_H
