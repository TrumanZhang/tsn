...
class EnhancedIeee8021qEncap : public cSimpleModule
{
  ...
  protected:
    ...
    virtual inet::Ieee8021qHeader *findVlanTag(const inet::Ptr<inet::EthernetMacHeader>& ethernetMacHeader);
    virtual inet::Ieee8021qHeader *addVlanTag(const inet::Ptr<inet::EthernetMacHeader>& ethernetMacHeader);
    virtual inet::Ieee8021qHeader *removeVlanTag(const inet::Ptr<inet::EthernetMacHeader>& ethernetMacHeader);
    ...
    virtual void processPacket(inet::Packet *packet, std::vector<int>& vlanIdFilter, std::map<int, int>& vlanIdMap, cGate *gate);
};
