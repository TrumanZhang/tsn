...
protected:
   ...
   */
  virtual void addScheduledTickListener(unsigned int idleTicks, IClockListener* listener);
...
public:
   ...
   *                  notified.
   */
  virtual void subscribeTick(IClockListener* listener, unsigned int idleTicks) override;
